...
public:
	...
	constexpr SimplexNoiseBase() noexcept = default;
...
private:
	...
	F raw(F point, A frequency) const noexcept {
	...
	typename V::Type raw(const V& point, A frequency) const noexcept {
	...
	static constexpr F falloff(F a, Args... v) noexcept {
